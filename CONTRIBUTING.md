Contributing to MooNET Core
============================

The MooNET Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MooNET Core project, and is not to be
confused with overall MooNET Network Protocol consensus changes.

Whether a pull request is merged into MooNET Core rests with the project merge
...
Patches that change MooNET consensus rules are considerably more involved than
...
Where a patch set proposes to change the MooNET consensus, it must have been
...
The project leader is the release manager for each MooNET Core release.

...
This means one can have an always-on moonetd instance running, and another local moonetd/moonet-qt instance which connects to this node and receives blocks from it.

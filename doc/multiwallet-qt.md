...
In order to support loading of multiple wallets in moonet-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is moonet.cpp.
...
Changes to moonet.cpp
----------------------
moonet.cpp is the entry point into moonet-qt, and as such, will require some minor modifications to provide hooks for

...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 8051;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // moonet starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // moonet: 1.5 minutes
        nTargetSpacingSlowLaunch = 10 * 60;  // moonet: 10 minutes (Slow launch - Block 288)
        nTargetSpacing = 1 * 60;  // moonet: 60 Seconds
        nMaturity = 10;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "moonet new blockchain is here";
	...
	//vSeeds.push_back(CDNSSeedData("moonet.cloud", "dnsseed1.moonet.cloud"));
	//vSeeds.push_back(CDNSSeedData("moonet.cloud", "dnsseed2.moonet.cloud"));
       ...
       vSeeds.push_back(CDNSSeedData("95.216.198.142", "95.216.198.142"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // moonet: 1 day
        nTargetSpacing = 1 * 60;  // moonet: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
       ...
       // nZerocoinStartTime = 1524711188;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet moonet addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet moonet script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet moonet BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet moonet BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet moonet BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // moonet: 1 day
        nTargetSpacing = 1 * 60;        // moonet: 1 minutes

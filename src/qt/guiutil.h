...
// Render moonet addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZmuu = false);
...
// Parse "moonet:" URI into recipient object, return true on successful parsing

...
#ifndef PIVX_CORE_NEW_GUI_muuGUI_H
#define PIVX_CORE_NEW_GUI_muuGUI_H
...
*/
class muuGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit muuGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~muuGUI();
...
#endif //PIVX_CORE_NEW_GUI_muuGUI_H

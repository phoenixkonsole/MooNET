...
#include "qt/moonet/settings/forms/ui_settingswalletrepairwidget.h"
...
SettingsWalletRepairWidget::SettingsWalletRepairWidget(muuGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to muuGUI::handleRestart()

...
public:
    ...
    void setZmuuControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzmuu_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzmuu_clicked();
    void on_pushButtonZmuuControl_clicked();
